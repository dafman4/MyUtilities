 ...
 * @author David
 */
public class ConfigInputStreamFormat implements InputStreamFormatter<Map<String, String>> {

	private final static Logger log = getLogger(ConfigInputStreamFormat.class);
	protected final static Pattern SPLITTER = Pattern.compile(" *=+ *");
	...
	public Map<String, String> decode(InputStream stream) {
		...
		while(true) {
			...
			try {
				...
				log.warn("This could potentially by an acceptable error.", e);
				break;
			}
	...
	@Override
	public String toString() { return "ConfigInputStreamFormat instance"; }
